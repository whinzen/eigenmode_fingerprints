...
def main():
    ...
    # sentence boundary = first token of each sentence
    df["boundary"] = (
    ...
    # stimulus-space boundary regressors by annotation run
    ...
    print(f"✅ Built stimulus-space boundary regressors for runs: {sorted(stim_regs.keys())}")

    # map stimulus runs onto actual subject run labels in sorted order
    ...
    for sub_dir in subjects:
        ...
        print(f"✅ {sub}: wrote {n} subject-specific boundary regressors")
