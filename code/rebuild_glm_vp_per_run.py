...
REGRESSOR_DIR = BASE / "pang_out/regressors/boundary_vp_hrf_per_subject"
OUT_DIR = BASE / "pang_out/glm_per_run/boundary_vp"
...
for subj in subjects:
    ...
    for func_file in sorted(func_subj_dir.glob("*_bold.func.gii")):
        ...
        out_name = fname.replace("_bold.func.gii", "_glm_boundary_vp.npy")
